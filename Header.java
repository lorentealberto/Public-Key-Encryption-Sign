...
public class Header {
  ...
  /**
   * Algoritmo de cifrado de clave p�blica  
   */
   ...
   * @param cipher - nombre est�ndar del algoritmo elegido
   */
   ...
   * @param signer - nombre est�ndar del algoritmo elegido
  ...
  public static void test() {
    ...
    if (fh2.load(fis)){
      System.out.println("Le�do, Algoritmo: "+fh2.getCipher());
    }
    else
    ...
    if (fh2.load(fis)){
      System.out.print("Le�do, Algoritmo: "+fh2.getSigner()+
    		  			" Firma: ");
      sign = fh2.getSign();
